...
public class UserDashBoardActivity extends AppCompatActivity {
    ...
    String strData[] = {"User", "Residents", "Event", "Payment", "Feedback", "NonMember","Staff", "Place"};

    int imgData[] = {R.drawable.user, R.drawable.member, R.drawable.event,
            R.drawable.maintanence, R.drawable.ic_feedback, R.drawable.ic_nonmember, R.drawable.staff, R.drawable.place};
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 0) {
                    ...
                    Intent intent = new Intent(UserDashBoardActivity.this, StaffDisplayActivity.class);
                    startActivity(intent);
                }else if (i == 7) {
                    Intent intent = new Intent(UserDashBoardActivity.this, PlaceDisplayActivity.class);
                    startActivity(intent);
                }
            }
        });
